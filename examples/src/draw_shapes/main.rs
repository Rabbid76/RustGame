...
pub fn main() {
    ...
    'running: loop {
        ...
        draw.rectangle(canvas.get_surface(), true, &ColorU8::from_hue_alpha(0, 25), Rect::new(50, 250, 50, 50), -1).unwrap();
        draw.circle(canvas.get_surface(), true, &ColorU8::from_hue_alpha(30, 25), (175, 275), 25, -1).unwrap();
        draw.ellipse(canvas.get_surface(), true, &ColorU8::from_hue_alpha(60, 25), (275, 275), (25, 15), angle as f32, -1).unwrap();
        draw.arc(canvas.get_surface(), true, &ColorU8::from_hue_alpha(120, 25), (375, 275), 25, 0.0..angle as f32, -1).unwrap();
        draw.elliptical_arc(
            canvas.get_surface(),
            true,
        ...
        .unwrap();
        draw.polygon(canvas.get_surface(), true, &ColorU8::from_hue_alpha(240, 25), &vec![(550, 300), (600, 300), (575, 250)]).unwrap();
